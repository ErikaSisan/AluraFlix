...
const Add = () => {
  ...
  return (
    <AddContainer>
      <MainTitleContainer>
        <h1>Novo Vídeo</h1>
        <p>Preencha o formulário para criar um novo card de vídeo</p>
      </MainTitleContainer>

      <FormStyles onSubmit={handleSubmit}>
        <TitleStyles>criar cartão</TitleStyles>
        ...
        <FormInput
          ...
          name="titulo"
          minlength="3"
          title="Você precisa ter pelo menos 3 caracteres para ser válido"
        >
          Título
        </FormInput>
        <OptionInput
